            ...
            <div className="ml-64 flex flex-col min-h-screen">
                ...
                <header className="flex flex-col justify-center items-center text-center py-32 px-4 bg-cover bg-center relative">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="mt-4 text-lg md:text-xl text-gray-300 font-medium tracking-wide">Manage Users, Orders, and More.</p><br />
                        <a href="#" className="mt-6 px-6 md:px-8 py-3 md:py-4 bg-neon-green text-white rounded-xl font-semibold text-base md:text-lg uppercase shadow-md hover:scale-105 transition transform">Manage Now</a>
                    </div>
                </header>
